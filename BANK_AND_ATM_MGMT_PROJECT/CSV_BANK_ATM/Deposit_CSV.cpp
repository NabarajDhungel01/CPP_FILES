...
#include <fstream>
#include <windows.h>
// we can pre-calculate the length of the password so that when user is entering the password we do the loop from i to ram.password.length()
...
p:
    ...
    cout << "\n 1.User ID          :";
    getline(cin, id);
    id = convert_space_to_line(id);         // reject if there is spaces in input
    cout << "\n 2.Name             :";
    getline(cin, name);
    ...
    cout << "\n 6.Password         :";
    getline(cin, pass);
    pass = convert_space_to_line(pass);     // reject if there is spaces in input
    cout << "\n 7.Phone No.        :";
    getline(cin, phone);
    phone = convert_space_to_line(phone);       // reject if there is spaces in input
    cout << "\n 8.Opening Balance  :";
    getline(cin, balance);  // verify if space is present while inputting the balance or not.
    balance = convert_space_to_line(balance);       // reject if there is spaces in input
    // show input things
    {
    cout << "\n\n INPUT iS :: \n\n";
    cout << "\n User ID       : " << id;
    ...
    if (!file) // if there is no file
    {
        ...
        file << "ID"<< ","<< "NAME"<< ","<< "FATHER'S_NAME"<< ","<< "ADDRESS"<< ","<< "PIN"<< ","<< "PASSWORD"<< ","<< "CONTACT"<< ","<< "BALANCE"<< "\n";
    ...
    else
    {
        ...
        file >> all; // this will point towards the second line which is  first  user record
